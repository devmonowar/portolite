...
function portolite_check_header() {
    ...
    elseif ( $portolite_header_style == 'header-style-3' ) {
        get_template_part( 'template-parts/header/header-3' );
    } 
    elseif ( $portolite_header_style == 'header-style-4' ) {
        get_template_part( 'template-parts/header/header-4' );
    } 
    elseif ( $portolite_header_style == 'header-style-5' ) {
        get_template_part( 'template-parts/header/header-5' );
    } 
    elseif ( $portolite_header_style == 'header-style-6' ) {
        get_template_part( 'template-parts/header/header-6' );
    } 
    elseif ( $portolite_header_style == 'header-style-7' ) {
        get_template_part( 'template-parts/header/header-7' );
    } 
    elseif ( $portolite_header_style == 'header-style-8' ) {
        get_template_part( 'template-parts/header/header-8' );
    } 
    elseif ( $portolite_header_style == 'header-style-9' ) {
        get_template_part( 'template-parts/header/header-9' );
    } 
    elseif ( $portolite_header_style == 'header-style-10' ) {
        get_template_part( 'template-parts/header/header-10' );
    } 
    elseif ( $portolite_header_style == 'header-style-11' ) {
        get_template_part( 'template-parts/header/header-11' );
    } 
    elseif ( $portolite_header_style == 'header-style-12' ) {
        get_template_part( 'template-parts/header/header-12' );
    } 
    elseif ( $portolite_header_style == 'header-style-13' ) {
        get_template_part( 'template-parts/header/header-13' );
    } 
    elseif ( $portolite_header_style == 'header-style-14' ) {
        get_template_part( 'template-parts/header/header-14' );
    } 
    elseif ( $portolite_header_style == 'header-style-15' ) {
        get_template_part( 'template-parts/header/header-15' );
    } 
    elseif ( $portolite_header_style == 'header-style-16' ) {
        get_template_part( 'template-parts/header/header-16' );
    } 
    elseif ( $portolite_header_style == 'header-style-17' ) {
        ...
        elseif ( $portolite_default_header_style == 'header-style-3' ) {
            get_template_part( 'template-parts/header/header-3' );
        }
        elseif ( $portolite_default_header_style == 'header-style-4' ) {
            get_template_part( 'template-parts/header/header-4' );
        }
        elseif ( $portolite_default_header_style == 'header-style-5' ) {
            get_template_part( 'template-parts/header/header-5' );
        }
        elseif ( $portolite_default_header_style == 'header-style-6' ) {
            get_template_part( 'template-parts/header/header-6' );
        }
        elseif ( $portolite_default_header_style == 'header-style-7' ) {
            get_template_part( 'template-parts/header/header-7' );
        }
        elseif ( $portolite_default_header_style == 'header-style-8' ) {
            get_template_part( 'template-parts/header/header-8' );
        }
        elseif ( $portolite_default_header_style == 'header-style-9' ) {
            get_template_part( 'template-parts/header/header-9' );
        }
        elseif ( $portolite_default_header_style == 'header-style-10' ) {
            get_template_part( 'template-parts/header/header-10' );
        }
        elseif ( $portolite_default_header_style == 'header-style-11' ) {
            get_template_part( 'template-parts/header/header-11' );
        }
        elseif ( $portolite_default_header_style == 'header-style-12' ) {
            get_template_part( 'template-parts/header/header-12' );
        }
        elseif ( $portolite_default_header_style == 'header-style-13' ) {
            get_template_part( 'template-parts/header/header-13' );
        }
        elseif ( $portolite_default_header_style == 'header-style-14' ) {
            get_template_part( 'template-parts/header/header-14' );
        }
        elseif ( $portolite_default_header_style == 'header-style-15' ) {
            get_template_part( 'template-parts/header/header-15' );
        }
        elseif ( $portolite_default_header_style == 'header-style-16' ) {
            get_template_part( 'template-parts/header/header-16' );
        }
        elseif ( $portolite_default_header_style == 'header-style-17' ) {
            get_template_part( 'template-parts/header/header-17' );
        }
        else {
            get_template_part( 'template-parts/header/header-1' );
...
// header logo
function portolite_header_sticky_logo() {?>
    <?php
        $portolite_sticky_logo = function_exists( 'get_field' ) ? get_field( 'portolite_sticky_logo' ) : NULL;
        $portolite_logo = get_theme_mod( 'portolite_sticky_logo', get_template_directory_uri() . '/assets/img/logo/logo-black-solid.svg' );
        $portolite_secondary_logo = get_theme_mod( 'seconday_logo',  get_template_directory_uri() . '/assets/img/logo/logo.svg');
        $portolite_site_logo_width = get_theme_mod( 'portolite_logo_width', '120');
    ?>
        <?php if ( !empty( $portolite_sticky_logo ) ) : ?>
        <a href="<?php print esc_url( home_url( '/' ) );?>">
            <img data-width="<?php echo esc_attr($portolite_site_logo_width); ?>" height="auto" class="logo-dark" src="<?php print esc_url( $portolite_sticky_logo );?>" alt="logo">
        </a>
        <?php else : ?>
            <a href="<?php print esc_url( home_url( '/' ) );?>">
            <img data-width="<?php echo esc_attr($portolite_site_logo_width); ?>" height="auto" class="logo-dark" src="<?php print esc_url( $portolite_logo );?>" alt="logo">
            <img data-width="<?php echo esc_attr($portolite_site_logo_width); ?>" height="auto" class="logo-light" src="<?php print esc_url( $portolite_secondary_logo );?>" alt="logo">
        </a>
        <?php endif; ?>
    <?php
}
...
function portolite_check_footer() {
    ...
    elseif ( $portolite_footer_style == 'footer-style-3' ) {
        get_template_part( 'template-parts/footer/footer-3' );
    }
    elseif ( $portolite_footer_style == 'footer-style-4' ) {
        get_template_part( 'template-parts/footer/footer-4' );
    }
    elseif ( $portolite_footer_style == 'footer-style-5' ) {
        get_template_part( 'template-parts/footer/footer-5' );
    }
    elseif ( $portolite_footer_style == 'footer-style-6' ) {
        get_template_part( 'template-parts/footer/footer-6' );
    }
    elseif ( $portolite_footer_style == 'footer-style-7' ) {
        get_template_part( 'template-parts/footer/footer-7' );
    }
    elseif ( $portolite_footer_style == 'footer-style-8' ) {
        get_template_part( 'template-parts/footer/footer-8' );
    }
    elseif ( $portolite_footer_style == 'footer-style-9' ) {
        get_template_part( 'template-parts/footer/footer-9' );
    }
    elseif ( $portolite_footer_style == 'footer-style-12' ) {
        get_template_part( 'template-parts/footer/footer-12' );
    }
    elseif ( $portolite_footer_style == 'footer-style-13' ) {
        get_template_part( 'template-parts/footer/footer-13' );
    }
    elseif ( $portolite_footer_style == 'footer-style-10' ) {
        ...
        elseif ( $portolite_default_footer_style == 'footer-style-3' ) {
            get_template_part( 'template-parts/footer/footer-3' );
        } 
        elseif ( $portolite_default_footer_style == 'footer-style-4' ) {
            get_template_part( 'template-parts/footer/footer-4' );
        } 
        elseif ( $portolite_default_footer_style == 'footer-style-5' ) {
            get_template_part( 'template-parts/footer/footer-5' );
        } 
        elseif ( $portolite_default_footer_style == 'footer-style-6' ) {
            get_template_part( 'template-parts/footer/footer-6' );
        } 
        elseif ( $portolite_default_footer_style == 'footer-style-7' ) {
            get_template_part( 'template-parts/footer/footer-7' );
        } 
        elseif ( $portolite_default_footer_style == 'footer-style-8' ) {
            get_template_part( 'template-parts/footer/footer-8' );
        } 
        elseif ( $portolite_default_footer_style == 'footer-style-9' ) {
            get_template_part( 'template-parts/footer/footer-9' );
        } 
        
        elseif ( $portolite_default_footer_style == 'footer-style-12' ) {
            get_template_part( 'template-parts/footer/footer-12' );
        }
        elseif ( $portolite_default_footer_style == 'footer-style-13' ) {
            get_template_part( 'template-parts/footer/footer-13' );
        }
        elseif ( $portolite_default_footer_style == 'footer-style-10' ) {
...
function portolite_copyright_text() {
   print get_theme_mod( 'portolite_copyright', esc_html__( 'Copyright © 2023 Theme_Pure. All Rights Reserved', 'portolite' ) );
}
