...
// portolite_ofer_sidebar_func
function portolite_offer_sidebar_func() {
    if ( is_active_sidebar( 'offer-sidebar' ) ) {

        dynamic_sidebar( 'offer-sidebar' );
    }
}
add_action( 'portolite_offer_sidebar', 'portolite_offer_sidebar_func', 20 );

// portolite_service_sidebar
function portolite_service_sidebar_func() {
    if ( is_active_sidebar( 'services-sidebar' ) ) {

        dynamic_sidebar( 'services-sidebar' );
    }
}
add_action( 'portolite_service_sidebar', 'portolite_service_sidebar_func', 20 );

// portolite_portfolio_sidebar
function portolite_portfolio_sidebar_func() {
    if ( is_active_sidebar( 'portfolio-sidebar' ) ) {

        dynamic_sidebar( 'portfolio-sidebar' );
    }
}
add_action( 'portolite_portfolio_sidebar', 'portolite_portfolio_sidebar_func', 20 );

// portolite_faq_sidebar
function portolite_faq_sidebar_func() {
    if ( is_active_sidebar( 'faq-sidebar' ) ) {

        dynamic_sidebar( 'faq-sidebar' );
    }
}
add_action( 'portolite_faq_sidebar', 'portolite_faq_sidebar_func', 20 );