...
function portolite_assets()
{
    return [
        'styles' => [
            ...
            // Subsets, not the full libraries — see the file headers.
            // `animate` is generated by
...
function portolite_asset_map()
{
    ...
    return [
        'main_slider' => [
            // `shapes` is the float-bob loop on the slider's drifting image.
            'css' => ['module-slider', 'owl-carousel', 'owl-theme', 'magnific-popup', 'shapes'],
            'js'  => ['owl-carousel', 'magnific-popup'],
        ],
        'about' => [
            'css' => array_merge(['module-about', 'shapes'], $wow_css),
