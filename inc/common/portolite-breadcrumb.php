...
function portolite_breadcrumb_func() {
    ...
    elseif ( is_single() && 'product' == get_post_type() ) {
        $title = get_theme_mod( 'breadcrumb_product_details', __( 'Shop', 'portolite' ) );
    } 
    elseif ( is_single() && 'courses' == get_post_type() ) {
      $title = esc_html__( 'Course Details', 'portolite' );
    } 
    elseif ( 'courses' == get_post_type() ) {
      $title = esc_html__( 'Courses', 'portolite' );
    } 
    elseif ( is_search() ) {
        $title = esc_html__( 'Search Results for : ', 'portolite' ) . get_search_query();
    } 
    elseif ( is_404() ) {
        $title = esc_html__( 'Page not Found', 'portolite' );
    } 
    elseif ( function_exists( 'is_woocommerce' ) && is_woocommerce() ) {
        $title = get_theme_mod( 'breadcrumb_shop', __( 'Shop', 'portolite' ) );
    } 
    elseif ( is_archive() ) {
    ...
    $bg_img_color = get_theme_mod( 'portolite_breadcrumb_bg_color', '#e1e1e1');
    $portolite_breadcrumb_shape_switch = get_theme_mod( 'portolite_breadcrumb_shape_switch', true );
    ...
    $portolite_breadcrumb_style = function_exists( 'get_field' ) ? get_field( 'breadcrumb_style' ) : NULL;
    $portolite_default_breadcrumb_style = get_theme_mod( 'choose_default_breadcrumb', 'breadcrumb-style-1' );
    ...
    <?php elseif ( $portolite_breadcrumb_style == 'breadcrumb-style-3' && empty($_GET['s']) ) : ?>
        ...
        <?php elseif ( $portolite_breadcrumb_style == 'breadcrumb-style-4' && empty($_GET['s']) ) : ?>
        ...
        <?php elseif ( $portolite_breadcrumb_style == 'breadcrumb-style-5' && empty($_GET['s']) ) : ?>
    ...
    <?php else : ?>
        <!--  from customizer -->
        <?php if ( $portolite_default_breadcrumb_style == 'breadcrumb-style-2' ) : ?>
        ...
        <?php elseif ( $portolite_default_breadcrumb_style == 'breadcrumb-style-3' ) : ?>
        ...
        <section class="breadcrumb__area breadcrumb__style-3 breadcrumb__spacing-2 include-bg pt-200 pb-235 <?php print esc_attr( $breadcrumb_class );?>" data-background="<?php print esc_attr($bg_img);?>" data-bg-color="<?php echo esc_attr($bg_img_color); ?>" data-padding-top="<?php echo esc_attr($padding_top) ?>px" data-padding-bottom="<?php echo esc_attr($padding_bottom) ?>px">
         ...
         <?php elseif ( $portolite_default_breadcrumb_style == 'breadcrumb-style-4' ) : ?>
        ...
        <?php elseif ( $portolite_default_breadcrumb_style == 'breadcrumb-style-5' ) : ?>
...
// portolite_search_form
function portolite_search_form() {
    ?>
     <div class="search-wrapper p-relative transition-3 d-none">
         <div class="search-form transition-3">
             <form method="get" action="<?php print esc_url( home_url( '/' ) );?>" >
                 <input type="search" name="s" value="<?php print esc_attr( get_search_query() )?>" placeholder="<?php print esc_attr__( 'Enter Your Keyword', 'portolite' );?>" >
...
add_action( 'portolite_before_main_content', 'portolite_search_form' );