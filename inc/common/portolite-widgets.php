...
function portolite_widgets_init() {
    ...
    for ( $num = 1; $num <= $footer_widgets; $num++ ) {
        register_sidebar( [
            'name'          => sprintf( esc_html__( 'Footer %1$s', 'portolite' ), $num ),
            'id'            => 'footer-' . $num,
            'description'   => sprintf( esc_html__( 'Footer column %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_2_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            ...
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 2 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-2-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 2 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_3_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 3 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-3-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 3 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_4_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 4 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-4-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 4 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_5_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 5 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-5-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 5 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_6_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 6 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-6-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 6 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_7_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 7 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-7-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 7 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_8_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 8 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-8-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 8 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_9_switch ) {
        for ( $num = 1; $num <= $footer_widgets +1; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 9 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-9-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 9 : %1$s', 'portolite' ), $num ),
    ...
    if ( $footer_style_12_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 12 : %1$s', 'portolite' ), $num ),
                'id'            => 'footer-12-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 12 : %1$s', 'portolite' ), $num ),
