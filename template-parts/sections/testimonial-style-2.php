    ...
    <section class="testimonial-two">
        <div class="testimonial-two__inner">
            ...
            <div class="testimonial-two__shape-2">
                <img src='<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/shapes/testimonial-two-shape-2.png'>
            </div>
            <div class="testimonial-two__shape-3">
                <img src='<?php echo esc_url(get_template_directory_uri()); ?>/assets/img//shapes/testimonial-two-shape-4.png'>
            </div>
