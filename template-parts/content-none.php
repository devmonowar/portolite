...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title blog-search-title no-results-title"><?php esc_html_e( 'Nothing Found', 'portolite' );?></h1>
	</header><!-- .page-header -->
	...
	<div class="pageontent blog-search-content">
        ...
        <p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'portolite' );?></p>
        <?php
            get_search_form();
