...
/**
 * Template part for displaying post tags and social share links
 *
 * @package portolite
 */
?>
...
<div class="blog-details__tag-and-social">
    ...
    <?php
    // Get the tags assigned to the current post
    $post_tags = get_the_tags();

    if (!empty($post_tags)) :
        // Limit number of tags shown (e.g. max 3)
        $limited_tags = array_slice($post_tags, 0, 3);
    ?>
        <!-- Tags Section -->
        <div class="blog-details__tag-box">
            <span class="blog-details__tag-title">
                <?php esc_html_e('Tags:', 'portolite'); ?>
            </span>
