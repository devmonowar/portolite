<?php 
   ...
   $portolite_menu_col = $portolite_header_right ? 'col-xxl-6 col-xl-6 col-lg-8 d-none d-lg-block' : 'col-xxl-9 col-xl-10 col-lg-10 col-md-8 col-sm-7 col-4 text-end';
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-8 col-sm-7 col-4">
                           <div class="header__bottom-right d-flex justify-content-end align-items-center">
                              ...
                              <div class="header__btn-10 ml-30 d-none d-sm-block">
                                 <a href="<?php echo esc_url($portolite_contact_button_link); ?>" class="tp-header-btn-3"><?php echo esc_html($portolite_contact_button_text); ?></a>
                              </div>
                              <?php endif; ?>
