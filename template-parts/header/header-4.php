<?php 
   ...
   $enable_sticky = !empty($portolite_sticky_switch) ? 'header__sticky' : '';
    ...
    // contact button
   $portolite_contact_button_text = get_theme_mod( 'portolite_contact_button_text', __( 'Start a project', 'portolite' ) );
   ...
   $portolite_header_hamburger_text = get_theme_mod( 'portolite_header_hamburger_text', __( 'Intro', 'portolite' ) );

   // header right
   $portolite_search = get_theme_mod( 'portolite_search', false );
   $portolite_header_right = get_theme_mod( 'portolite_header_right', false );
   $portolite_menu_col = $portolite_header_right ? 'col-xl-6 col-lg-7 d-none d-lg-block' : 'col-xl-10 col-lg-9 col-md-6 col-6 text-end';
                            ...
                            <?php if ( !empty( $portolite_phone_num ) ): ?>
                              <div class="header__call d-none d-xl-flex align-items-center">
                                 ...
                                 <div class="header__call-content">
                                    <p><?php echo esc_html($portolite_phone_title); ?></p>
                                    <h4><a href="tel:<?php echo esc_attr($portolite_phone_num); ?>"><?php echo esc_html($portolite_phone_num); ?></a></h4>
                                 </div>
                              </div>
                              <?php endif; ?>
                              ...
                              <div class="header__btn-5 d-none d-xl-block ml-30">
                                 <a href="<?php echo esc_url($portolite_contact_button_link); ?>" class="tp-btn-orange"><?php echo esc_html($portolite_contact_button_text); ?></a>
                              </div>
                              <?php endif; ?>
