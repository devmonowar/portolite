<?php 
   ...
   $portolite_menu_col = $portolite_header_right ? 'col-xxl-6 col-xl-8 col-lg-8 d-none d-lg-block text-center' : 'col-xxl-9 col-xl-10 col-lg-10 col-md-8 col-sm-7 col-4 text-end';
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-xxl-3 col-xl-2 col-lg-2 col-md-8 col-sm-7 col-4">
                           <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                              ...
                              <?php if ( !empty( $portolite_social_switch ) ): ?>
                              ...
                              <div class="header__btn d-none d-lg-block">
                                 <a href="<?php echo esc_url($portolite_contact_button_link); ?>" class="tp-header-btn"><?php echo esc_html($portolite_contact_button_text); ?></a>
                              </div>
                              <?php endif; ?>
