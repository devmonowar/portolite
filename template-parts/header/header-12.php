<?php 
   ...
   $enable_sticky = !empty($portolite_sticky_switch) ? 'header__sticky' : '';
    ...
    $portolite_header_login = get_theme_mod( 'portolite_header_login', false );
    $portolite_header_wishlist = get_theme_mod( 'portolite_header_wishlist', false );
    $portolite_header_cart = get_theme_mod( 'portolite_header_cart', false );
   ...
   $portolite_menu_col = $portolite_header_right ? 'col-xxl-6 col-xl-7 d-none d-xl-block' : 'col-xxl-11 col-xl-10 col-lg-8 col-md-8 col-sm-7 col-4 text-end';
                        ...
                        <?php if ( !empty( $portolite_header_search ) ): ?>
                           <div class="header__search-13">
                              <form action="<?php print esc_url( home_url( '/' ) );?>">
                                 <div class="header__search-input-13 d-none d-xxl-block">
                                    <input type="text" placeholder="<?php print esc_attr__( 'Search for products...', 'portolite' );?>" name="s" value="<?php print esc_attr( get_search_query() )?>">
                                    <button type="submit">
                           ...
                           <div class="header__action-13 d-none d-md-block">
                              <ul>
                                 ...
                                 <?php if ( !empty( $portolite_header_login ) && class_exists( 'WooCommerce' )): ?>
                                 <li>
                                 ...
                                 if(class_exists( 'WPCleverWoosw' ) && !empty($portolite_header_wishlist)) :
                                    $wishlist_data = new WPCleverWoosw();
   
                                    $key = $wishlist_data::get_key();
                                    $products = $wishlist_data::get_ids( $key );
                                    $count    = count( $products );
                                 if ( !empty( $portolite_header_wishlist ) ): 
                                 ...
                                 <?php if ( !empty( $portolite_header_cart ) && class_exists( 'WooCommerce' ) ): ?>
                                 <li>
...
<?php print portolite_shopping_cart(); ?>
<?php endif; ?>