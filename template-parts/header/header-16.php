...
?>
      ...
      <!-- header area start -->
      <header>
         <div class="header__area header__simple <?php echo esc_attr($portolite_transparent_enable); ?>">
                        ...
                        <div class="col-5">
                           <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                              ...
                              <div class="header__btn d-none d-md-block">
                                ...
                                <a href="<?php echo esc_url($portolite_contact_button_link); ?>" class="tp-btn tp-btn-black">
