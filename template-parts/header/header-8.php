<?php 
   ...
   $portolite_menu_col = $portolite_header_right ? 'col-xxl-7 col-xl-7 col-lg-8 d-none d-lg-block' : 'col-xxl-9 col-xl-9 col-lg-10 col-md-8 col-sm-7 col-4 text-end';
                        ...
                        <div class="<?php echo esc_attr($portolite_menu_col); ?>">
                           <div class="main-menu main-menu-9 main-menu-ff-space">
                              ...
                              <div class="header__hamburger ml-50 d-lg-none">
                                 <button type="button"  class="hamburger-btn-8 hamburger-btn-8-black offcanvas-open-btn"><?php echo esc_html($portolite_header_hamburger_text); ?></button>
                              </div>
                           </div>
                        </div>
