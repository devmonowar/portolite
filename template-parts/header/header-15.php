<?php 
   ...
   if($is_it_transparent_header && !$portolite_transparent_header) :
      $portolite_transparent_enable = 'header__transparent header__white-solid header__white-solid-2'; 
      $portolite_transparent_logo = true;

   
   // if transparent set from acf
   elseif($is_it_transparent_header && $portolite_transparent_header) :
      $portolite_transparent_enable = 'header__white-solid header__white-solid-2';
      $portolite_transparent_logo = false;

   // style from customizer
   else :
      $portolite_transparent_enable = $portolite_transparent_header ? 'header__transparent header__white-solid header__white-solid-2' : 'header__white-solid header__white-solid-2';
                  ...
                  <div class="row align-items-center">
                     <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-5 col-8">
                        <div class="logo logo-border">
                           <?php if($portolite_transparent_logo == true) :?>
