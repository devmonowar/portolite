<?php 
   ...
   $portolite_menu_col = $portolite_header_right ? 'col-xxl-6 col-xl-8 col-lg-8 d-none d-lg-block' : 'col-xxl-10 col-xl-10 col-lg-10 col-md-8 col-sm-7 col-4 text-end';
                           ...
                           <div class="header__bottom-right-8 d-flex justify-content-end align-items-center">
                              ...
                              <div class="header__action-8 header__action-11 d-none d-xl-block">
                                 <ul>
                                    ...
                                    <li>
                                       <button type="button"  class="hamburger-btn hamburger-btn-text  offcanvas-open-btn" data-menu-text="<?php echo esc_attr($portolite_header_hamburger_text); ?>">
                                          <span></span>
                                          <span></span>
                                          <span></span>
                                       </button>
