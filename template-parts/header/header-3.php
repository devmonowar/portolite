<?php 
   ...
   $portolite_menu_col = $portolite_header_right ? 'col-xxl-7 col-xl-8 col-lg-8 d-none d-lg-block' : 'col-xxl-10 col-xl-10 col-lg-10 col-md-8 col-sm-7 col-4';
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="<?php echo esc_attr($portolite_menu_col); ?>">
                        <div class="main-menu pl-55 main-menu-ff-space">
                           ...
                           <!-- for wp -->
                           <div class="header__hamburger ml-20 d-lg-none <?php echo esc_attr($portolite_header_hamburger_right); ?>">
                     ...
                     <div class="col-xxl-3 col-xl-2 col-lg-2 col-md-8 col-sm-7 col-4">
                        ...
                        <?php if ( !empty( $portolite_header_hamburger ) ): ?>
                           <div class="header__intro">
                              <p><?php echo esc_html($portolite_header_hamburger_text); ?></p>
                           </div>
