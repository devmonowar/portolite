...
$footer_bg_color = get_theme_mod( 'portolite_footer_bg_color', '#002E24' );

// bottom dynamic
$portolite_footer_bottom_menu = get_theme_mod( 'portolite_footer_bottom_menu' );
$portolite_footer_bottom_language = get_theme_mod( 'portolite_footer_bottom_language', false );

if($portolite_footer_bottom_menu && $portolite_footer_bottom_language){
    $portolite_copyright_center = 'col-md-4 col-sm-6 text-sm-center';
}
elseif(!$portolite_footer_bottom_menu && $portolite_footer_bottom_language){
    $portolite_copyright_center = 'col-md-8 col-sm-6 text-start';
}
elseif($portolite_footer_bottom_menu && !$portolite_footer_bottom_language){
    $portolite_copyright_center = 'col-md-8 col-sm-6 text-sm-end';
}
else{
    $portolite_copyright_center = 'col-md-12 col-sm-12 text-center';
}
            ...
            <div class="footer__bottom-7">
                <div class="container">
                    <div class="footer__bottom-inner-7">
                        ...
                        <?php if ( !empty( $portolite_footer_bottom_language ) ): ?>
                        <div class="col-md-4">
                            <div class="footer__lang d-flex align-items-center justify-content-md-end">
                                ...
                                <div class="footer__lang-wrapper">
                                    ...
                                    if ( !empty( $languages ) ):
                                        ...
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <span class="footer__lang-selected-lang tp-lang-toggle-2" id="tp-footer-lang-toggle"><?php print esc_html__('English', 'portolite'); ?></span>
                                    <?php endif; ?>
                                    <?php do_action('portolite_footer_language'); ?>    
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
