...
*/
    ...
    $footer_bg_color = get_theme_mod( 'portolite_footer_bg_color', '#090E38' );
         ...
         <div class="footer__area footer__style-2" data-bg-color="<?php print esc_attr( $bg_color );?>" data-background="<?php print esc_url( $bg_img );?>">
            ...
            <div class="footer__top">
               <div class="footer__shape">
                  <img class="footer__shape-3" src="<?php echo get_template_directory_uri() . '/assets/img/footer/footer-shape-1.png' ?>" alt="<?php echo esc_attr__('shape', 'portolite'); ?>">
               </div>
