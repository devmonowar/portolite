...
$portolite_event_button_text = get_theme_mod( 'portolite_event_button_text', __( 'Make an Appointment', 'portolite' ) );
$portolite_event_button_url = get_theme_mod( 'portolite_event_button_url', __( '#', 'portolite' ) );

?>

    <div class="event__sidebar mt-5 ml-50">
        <div class="event__widget mb-40">
            <h3 class="event__widget-title"><?php echo esc_html__('About Speaker: ', 'portolite'); ?></h3>
        ...
        <div class="event__widget mb-20">
            <h3 class="event__widget-title"><?php echo esc_html__('Event Info', 'portolite') ?></h3>
            <div class="event__widget-content">
                <div class="event__details-info">
                    ...
                    <div class="event__details-info-item d-flex align-items-start">
                        ...
                        <div class="event__details-info-content">
                            <h4 class="event__details-info-title"><?php echo esc_html__('Date', 'portolite'); ?></h4>
                    ...
                    <div class="event__details-info-item d-flex align-items-start">
                        ...
                        <div class="event__details-info-content">
                            <h4 class="event__details-info-title"><?php echo esc_html__('Venue: ', 'portolite'); ?></h4>
                    ...
                    <div class="event__details-info-item d-flex align-items-start">
                        ...
                        <div class="event__details-info-content">
                            <h4 class="event__details-info-title"><?php echo esc_html__('Time', 'portolite'); ?></h4>
                ...
                <?php if(!empty($data['etn_deadline_value'])): ?>
                    <div class="event__details-info-item d-flex align-items-start">
                        ...
                        <div class="event__details-info-content">
                            <h4 class="event__details-info-title"><?php echo esc_html__('Reg. Deadline: ', 'portolite'); ?></h4>
        ...
        <?php if(!empty($portolite_event_button_url)) : ?>
        <div class="event__widget">
            <div class="event__details-btn">
                <a href="<?php echo esc_url($portolite_event_button_url); ?>" class="tp-btn w-100"><?php echo esc_html($portolite_event_button_text); ?></a>
            </div>
        </div>
        <?php endif; ?>
