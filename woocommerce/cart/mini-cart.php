						...
						<?php
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									...
									esc_attr__( 'Remove this item', 'portolite' ),
									esc_attr( $product_id ),
...
<?php else : ?>
   ...
   <div class="cartmini__empty text-center">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/cartmini/empty-cart.png" alt="<?php echo esc_attr__('empty-cart', 'portolite'); ?>">
